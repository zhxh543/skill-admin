  ...
  <div id="expert">
        ...
        <el-row>
          ...
          <el-col :span="19" :offset="1">
            <el-row class="el_line">
              <el-col :span="4" class="el_name">姓名</el-col>
              <el-col :span="10">
            ...
            <el-row class="el_row el_line">
              <el-col :span="4" class="el_name">简介</el-col>
              <el-col :span="10">
                <el-input v-model.trim="item.synopsis" type="textarea" disabled></el-input>
              </el-col>
            </el-row>
            <el-row class="el_line el_row">
              <el-col :span="4" class="el_name">链接地址</el-col>
              <el-col :span="10">
                <el-input v-model="item.customUrl" disabled></el-input>
              </el-col>
            </el-row>
          </el-col>
        </el-row>
    ...
    >
      <el-row>
        ...
        <el-col :span="19" :offset="1">
          <el-row class="el_line">
            <el-col :span="4" class="el_name">姓名</el-col>
            <el-col :span="20">
              <el-input v-model.trim="info.name" placeholder="请输入姓名"></el-input>
            </el-col>
          </el-row>
          <el-row class="el_line el_row">
            <el-col :span="4" class="el_name">序号</el-col>
            <el-col :span="20">
              <el-input v-model.trim="info.seq" placeholder="请输入序号" maxlength="10"></el-input>
            </el-col>
          </el-row>
          <el-row class="el_row el_line">
            <el-col :span="4" class="el_name">简介</el-col>
            <el-col :span="20">
              <el-input v-model.trim="info.synopsis" type="textarea" placeholder="请输入简介" maxlength="200"></el-input>
            </el-col>
          </el-row>
          <el-row class="el_line el_row">
            <el-col :span="4" class="el_name">链接地址</el-col>
      ...
      <div slot="footer">
        ...
        <el-button type="primary" size="mini" @click="editImg">确 定</el-button>
      </div>
    </el-dialog>
    <!--图片裁切弹窗-组件-->
  ...
  export default {
    ...
    methods: {
      ...
      showDialog() {
        ...
        switch (parseInt(this.info.linkType + '')) {
          case 0:
      ...
      getUrl(linkData) {
        ...
        switch (parseInt(linkData.linkType)) {
          case 0:
            ...
            this.info.linkUrl = linkData.linkUrl;
            break;
          case 1:
      ...
      getList() {
        this.$ajax.get('/team/teams').then(res => {
          if (res.status === 200) {
      ...
      deleteItem(id) {
        if (id) {
          this.$confirm('此操作永久删除该条信息，是否删除?', '提示', {
            ...
            this.$ajax.delete(`/team/delete/${id}`).then(res => {
              if (res.status === 200)
                this.$message.success(res.data.msg);
              else
                this.$message.error(res.data.msg);
